...
from e2e_tests.test.utilities.send_flow_helpers import generate_multisig_invoice_and_send
...
def test_hide_exhausted_asset_on_offline_multisig(wallets_and_operations: WalletTestSetup, wallet_variant_name):
    ...
    with allure.step('Issue NIA asset from watch-only coordinator'):
        wallets_and_operations.second_page_objects.sidebar_page_objects.click_fungibles_button()
    ...
    with allure.step('Generate invoice and send asset'):
