...
from e2e_tests.test.utilities.multisig_send_flow_helpers import multisig_issue_asset_flow
from e2e_tests.test.utilities.multisig_send_flow_helpers import offline_multisig_issue_asset_test_flow
...
@allure.feature('Issue NIA asset for offline multisig')
@allure.story('Issue NIA asset without sufficient sats for offline multisig wallet')
def test_issue_nia_without_sufficient_sats_for_offline_multisig(wallets_and_operations: WalletTestSetup, wallet_variant_name):
    """
...
@pytest.mark.parametrize('test_environment', [3], indirect=True)
@allure.feature('Issue NIA asset for offline multisig')
@allure.story('Issue NIA asset with sufficient sats for offline multisig wallet')
def test_issue_nia_with_sufficient_sats_for_offline_multisig(wallets_and_operations: WalletTestSetup, wallet_variant_name):
    """
