...
ERROR_RGB_LIB_INCOMPATIBILITY = 'The version of the rgb lib is incompatible with the one used to initialize the wallet'
...
ERROR_OPERATION_NOT_FOUND_TO_REJECT = 'Operation not found to reject'