...
INFO_VALIDATION_OF_KEYRING_ACCESS = 'Please wait for validation of keyring access'
INFO_BACKUP_COMPLETED = 'Backup completed! Your data is safe and secure.'
INFO_BACKUP_COMPLETED_KEYRING_LOCKED = 'Backup completed successfully! Please unlock the wallet to continue.'
...
INFO_OPERATION_COMPLETED_AND_FINALIZED = 'Operation completed and finalized!'
INFO_SIGNED_SUCCESSFULLY_WAITING_FOR_COSIGNERS = 'Signed successfully. Waiting for other signers.'
INFO_BITCOIN_SENT_SUCCESSFULLY = 'Bitcoin sent successfully!'
INFO_ASSET_ISSUED_INFLATED_SUCCESSFULLY = 'Asset issued/inflated successfully!'
INFO_OPERATION_POSTED_TO_BRIDGE_SUCCESSFULLY = 'Operation posted to bridge successfully.'
INFO_OPERATION_POSTED_TO_MULTISIG_BRIDGE = 'Operation posted to multisig bridge.'
