    ...
    mock_stdout = json.dumps({
        'blockdevices': [
            ...
            },
            {
                ...
                'tran': 'usb',
                'children': [
                    {'name': 'sdb1', 'mountpoint': '/media/usb1', 'label': 'USB_DRIVE'},
...
def test_get_macos_devices_success(mock_get_info, mock_run, detector):
    ...
    mock_run.return_value = MagicMock(stdout="/dev/disk2 (external, physical):\n 0: GUID_partition_scheme\n 1: EFI\n 2: Apple_APFS Disk2S2 disk2s2")
...
def test_detect_usb_drives_success(mock_get_available, detector):
    ...
    mock_get_available.return_value = {'usb1': {'mountpoint': '/m1', 'label': 'L1'}}
